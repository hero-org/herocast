...
const CastRow: React.FC<CastRowProps> = ({ cast, searchTerm }) => {
  ...
  return React.createElement(
    ...
    React.createElement(
      ...
      highlightSearchTerm(cast.text, searchTerm),
    ),
    cast.embeds &&
      ...
      React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(
            ...
            "Your Daily Digest from herocast",
          ),
          listsWithCasts.map(({ listName, searchTerm, casts }) =>
            React.createElement(
              ...
              React.createElement(
                Text,
                { className: "text-2xl font-semibold mb-4 text-[#18181b]" },
                listName,
              ),
              casts.length > 0
                ? casts.map((cast) =>
                    React.createElement(CastRow, {
                      key: cast.hash,
                      cast: cast,
                ...
                : React.createElement(
                    ...
                    "No new casts in this list today.",
                  ),
            ),
          ),
        ),
...
export const getHtmlEmail = (props: EmailProps): string =>
  render(React.createElement(Email, props));
