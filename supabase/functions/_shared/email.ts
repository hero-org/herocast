      ...
      return React.createElement(
        ...
        casts.length > 0
          ? [
            ...
            isCastsTruncated && React.createElement(Text, { className: "text-sm italic text-gray-500 mt-2" }, `and more casts...`)
          ]
    ...
    React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(Text, { className: "text-3xl font-bold mb-6 text-[#18181b]" }, "your daily farcaster digest from herocast"),
