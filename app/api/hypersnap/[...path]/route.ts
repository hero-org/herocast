...
const ROUTE_CONFIG: Record<string, { ttl: number | null }> = {
  ...
  'user/bulk': { ttl: 600 },
  'user/search': { ttl: 300 },
  'user/channels': { ttl: 600 },
  'user/best_friends': { ttl: 600 },
  'following/suggested': { ttl: 300 },
  feed: { ttl: 120 },
  'feed/following': { ttl: 120 },
  'feed/channels': { ttl: 120 },
  'feed/user/casts': { ttl: 120 },
  'feed/user/replies_and_recasts': { ttl: 120 },
  'feed/user/popular': { ttl: 120 },
  'reaction/user': { ttl: 120 },
  'reaction/cast': { ttl: 120 },
  cast: { ttl: 600 },
  'cast/bulk': { ttl: 600 },
