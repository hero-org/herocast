            ...
            <div className="mt-4 lg:w-1/2 lg:mt-0">
                <div className="mx-0 max-w-2xl">
                    ...
                    <p className="mt-2 text-md leading-8 text-foreground/70">
                        ...
                        and click on the tree you want to use. In the top right corner, you will see the tree ID and the
                        Hats ID. You will need to use the Hats ID for the admin role and for the caster role.
                    </p>
                </div>
