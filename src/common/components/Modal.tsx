...
const Modal = ({
  ...
  <Dialog.Root open={open} onOpenChange={setOpen} modal={false}>
    <Dialog.Portal>
      ...
      <Dialog.Content
        onPointerDownOutside={(event: any) => {alert("yo"); event.preventDefault()}}
        className="data-[state=open]:animate-contentShow fixed bg-background top-[45%] left-[50%] w-[100vw] max-w-[600px] translate-x-[-50%] translate-y-[-40%] rounded-[6px] p-[25px] shadow-[hsl(206_22%_7%_/_35%)_0px_10px_38px_-10px,_hsl(206_22%_7%_/_20%)_0px_10px_20px_-15px] focus:outline-none"
      >
        {title && (
