...
const ProfileInfo = ({
            ...
            <TooltipProvider>
                <Tooltip>
                    ...
                    <TooltipContent
                        ...
                        sideOffset={5}
                    >
                        Social Capital Scores (SCS) are a measure of each Farcaster user&apos;s influence in the
    ...
    const shouldRenderFullInfo = showFullInfo && (profile?.airstackSocialInfo || profile?.icebreakerData);
