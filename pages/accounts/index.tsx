...
export default function Accounts() {
    ...
    const pendingAccounts =
        accounts.filter(
            (account) =>
                account.status === AccountStatusType.pending && account.platform === AccountPlatformType.farcaster
        ) || [];
    const hasOnlyLocalAccounts =
        accounts.length &&
        accounts.every((account) => account.platform === AccountPlatformType.farcaster_local_readonly);
    ...
    const renderSignupForNonLocalAccount = () => (
        <Card>
            <CardHeader>
                ...
                <CardDescription>
                    A readonly account is great for browsing, but you need a full account to start casting and interact
                    with others on Farcaster.
                </CardDescription>
            </CardHeader>
            <CardFooter>
                <Button
                        ...
                        <Card>
                            <CardHeader>
                                ...
                                <CardDescription className="text-lg">
                                    Follow these steps to create a shared Farcaster account. Shared accounts are powered
                                    by Hats Protocol 🧢.
                                </CardDescription>
                            </CardHeader>
