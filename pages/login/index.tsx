    ...
    <AuthKitProvider config={authKitConfig}>
      <div className="w-full max-w-full min-h-screen">
        <div className="container relative h-screen flex-col items-center grid lg:max-w-none lg:grid-cols-2 lg:px-0">
          <div className="relative h-full flex-col bg-muted p-10 text-foreground flex">
            ...
            <div className="relative z-20 mt-24">
              <div className="text-center">
                <h1 className="bg-gradient-to-tl from-white via-stone-200 to-stone-500 bg-clip-text text-center text-4xl font-bold leading-tight tracking-tight text-transparent drop-shadow-sm dark:from-white dark:via-gray-200 dark:to-stone-500 md:text-7xl md:leading-[6rem] lg:leading-[1.1]">
                  <p className="inline-block">
                    ...
                    <svg
                      ...
                      fill="#8A63D2"
                      className="ml-4 bg-gray-100 rounded-lg inline-block items-center"
                    >
                ...
                <p className="mt-6 text-lg font-medium leading-0 text-gray-200">
                  ...
                  <div className="mx-auto max-w-3xl flex-none sm:max-w-5xl lg:max-w-none">
                    <div className="-m-2 rounded-xl bg-gray-900/5 p-2 ring-1 ring-inset ring-gray-900/10 lg:-m-4 lg:rounded-2xl lg:p-4">
                      <img
                        ...
                        width={2432}
                        height={1442}
                        className="w-full max-w-[18rem] md:max-w-[38rem] lg:max-w-[30rem] xl:max-w-[40rem] rounded-md shadow-2xl ring-1 ring-gray-900/10"
                      />
                    </div>
                  </div>
                </div>
          ...
          <div
            id="login-form"
            className="bg-gray-900 h-full w-full p-8 pt-24 lg:pt-36"
          >
