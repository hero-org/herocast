          ...
          <div className="relative h-full flex-col bg-muted p-10 text-foreground flex">
            ...
            <div className="relative z-20 mt-24">
              <div className="text-center">
                <h1 className="bg-gradient-to-tl from-white via-gray-300 to-stone-500 bg-clip-text text-center text-4xl font-bold leading-tight tracking-tight text-transparent drop-shadow-sm dark:from-white dark:via-gray-200 dark:to-stone-500 md:text-7xl md:leading-[6rem] lg:leading-[1.1]">
