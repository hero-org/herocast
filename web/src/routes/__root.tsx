...
// ?url -> one bundled stylesheet, linked in the SSR <head> (no FOUC). Vite inlines
// the @fontsource + Satoshi @font-face imports inside it.
import appCss from '@/styles/globals.css?url';

// Root document. Mirrors app/layout.tsx: <html lang="en" suppressHydrationWarning>
// (required for next-themes class mutation) + <body class="font-sans no-scrollbar">.
